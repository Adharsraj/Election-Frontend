  ...
  return (
    <div className="md:flex bg-gray-900 min-h-screen  max-h-fit text-white">
      ...
      <div className="border bg-gray-50 justify-center items-center w-full  text-center flex  flex-col px-4">
        ...
        >
          {userImage ? (
            <img src={userImage} alt="Selected" className="h-32 w-32 rounded-full" />
          ) : (
            ...
            <div className="w-full p-4 md:w-1/2 bg-white">
              ...
              <Form.Item name="currentposition">
                ...
                >
                  ...
                  <Select.Option value="Vice-president">
                    Vice-President
                  </Select.Option>
                  <Select.Option value="General-secretary">
                    General Secretary
                  </Select.Option>
                  <Select.Option value="Joint-secretary">
                    Joint Secretary
                  </Select.Option>
                  <Select.Option value="Treasurer">Treasurer</Select.Option>
                  <Select.Option value="Executive-member">
                    Executive Member
                  </Select.Option>
                </Select>
              </Form.Item>
