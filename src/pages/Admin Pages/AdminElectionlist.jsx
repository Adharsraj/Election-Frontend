      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-max table-auto text-left">
            ...
            <tbody>
              {electionData.map((m) => (
                <tr key={m._id} className="even:bg-blue-gray-50/50">
                  <td className="p-4">
                    <Typography
                      variant="small"
                      color="blue-gray"
                  ...
                  <td className="p-4">
                    ...
                    >
                                          ...
                                          {m.startDate?.split("T")[0]}                    </Typography>
                  </td>
                  <td className="p-4">
                    <Typography
                      variant="small"
                      ...
                      className="font-normal"
                    >
{m.endDate?.split("T")[0]}                    </Typography>
                  </td>
                  {/* <td className="p-4">
                    <svg
                  ...
                  {/* <td
                    ...
                    onClick={() => handleDeleteeClick(m._id)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
              ...
              <div className="rounded-md bg-white p-6 shadow-lg">
                ...
                <div className="mt-4 flex justify-end">
                  <button
                    ...
                    onClick={() => handleConfirmeDelete(id)}
                  >
                    Confirm
                  </button>
                  <button
                    className="rounded bg-gray-300 px-4 py-2 text-gray-800"
                    onClick={handleCanceleDelete}
                  >
                    Cancel
                  </button>
                </div>
